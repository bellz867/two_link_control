...
class Dynamics():
    ...
    def __init__(self,alpha=0.2*np.identity(2),betar=0.1*np.identity(2),betadel=0.1*np.identity(2),gammath=0.01,gammaw=0.01,gammav=0.01,lambdaCL=0.1,YYminDiff=0.1,kCL=0.9,tauN=0.1,phiN=0.01,phiDN=0.05,phiDDN=0.05,l=5,deltaT=1.0,useCL=True,useNN=True,useYth=True,useBias=True):
        """
